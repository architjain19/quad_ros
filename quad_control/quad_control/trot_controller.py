...
class LegController(Node):
    def __init__(self):
        ...
        self.i = 0
        # print(self.calculate_inverse_kinematics(-0.075, 0.3))
    ...
    def trace_trajecrtory_cb(self):
        ...
        if angles is None:
            ...
            if self.leg_count%2 == 0:
                # point.positions = [angle1, angle2, -0.8205510828083752, 1.6411021656167504, -0.8205510828083752, 1.6411021656167504, angle1, angle2]
                point.positions = [angle1, angle2, -1.0364461904514088, 1.5829350546490895, -1.0364461904514088, 1.5829350546490895, angle1, angle2]
            else:
                # point.positions = [-0.8205510828083752, 1.6411021656167504, angle1, angle2, angle1, angle2, -0.8205510828083752, 1.6411021656167504]
                point.positions = [-1.0364461904514088, 1.5829350546490895, angle1, angle2, angle1, angle2, -1.0364461904514088, 1.5829350546490895]
            point.time_from_start.sec = 1  # Adjust timing as needed
            trajectory_msg.points.append(point)
...
def main(args=None):
    ...
    global walk
    walk = leg_controller.create_timer(1.0, leg_controller.test_walk)
